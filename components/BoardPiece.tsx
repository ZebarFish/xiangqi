...
export const BoardPiece: React.FC<BoardPieceProps> = ({ piece, isSelected, onClick, rotate = false }) => {
  ...
  return (
    <div 
      className={`absolute flex justify-center items-center cursor-pointer transition-all duration-200 z-10 p-0.5 sm:p-1`}
      style={style}
      onClick={(e) => {
        e.stopPropagation();
        onClick();
    ...
    >
      <div className={`
        ...
        ${isSelected ? 'ring-2 sm:ring-4 ring-blue-400 scale-110 z-20' : 'hover:scale-105'}
